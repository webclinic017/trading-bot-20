...
from trading_bot import app, db
...
from trading_bot.form.configuration_form import ConfigurationForm
from trading_bot.form.portfolio_form import PortfolioForm
