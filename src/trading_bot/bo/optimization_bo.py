...
class OptimizationBO:
    ...
    @staticmethod
    def optimise(tables: List[Dict[str, DataFrame]], strategy: StrategyEnum) -> None:
        ...
        if evaluation is None:
            ...
            optimise_sum: Decimal = evaluation.sum
        while True:
    ...
    def start(cls, backward_portfolio: Callable[[], List[str]], number: int, group_number: int) -> None:
        ...
        cls.optimise(IntradayBO.intraday_list_group(groups), strategy)
